...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2015 at 04:45 AM
...
(1, 'Tom', 'Cruise', '1962-07-03', '5''7"'),
(2, 'Bill', 'Murray', '1950-09-21', '6''2"'),
(3, 'Wes', 'Anderson', '1969-05-01', '6''1"'),
(4, 'Jennifer', 'Lawrence', '1990-08-15', '5''9"'),
(5, 'Linda', 'Cardellini', '1975-06-25', '5''3"');
...
(104, 'tester', '2015-08-12', 'test@test.comt', '09876', 'you are', '999-999-9999');
...
CREATE TABLE IF NOT EXISTS `test` (
  `id` int(11) NOT NULL,
  `dataone` varchar(100) NOT NULL,
  `datatwo` varchar(100) NOT NULL
